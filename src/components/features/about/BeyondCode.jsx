                ...
                {isHovered && (
                    ...
                    >
                        <div className="flex flex-col gap-2.5">
                            <span className="text-[13px] uppercase tracking-[0.22em]  font-mono font-bold text-center border-b border-white/10 dark:border-black/10 pb-2 mb-1 text-zinc-500 dark:text-zinc-700">Snapshot</span>
                            <ul className="space-y-1.5">
                                {favoriteList.map((item, idx) => (
                                    <li key={idx} className="flex items-center gap-2.5 pr-4">
                                        ...
                                        <span className="font-bold text-[12px] tracking-tight">{item}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-3xl md:text-5xl font-instrument italic font-normal text-gray-900 dark:text-white tracking-tight leading-tight">
                            Beyond <span className="font-inter not-italic font-bold text-gray-400 dark:text-zinc-600">the keyboard.</span>
                        </h2>
                        ...
                        >
                            ...
                            <div className="text-xl md:text-2xl font-inter font-light text-gray-700 dark:text-zinc-300 leading-relaxed tracking-tight relative z-10">
                                Beyond the code, I'm all about <FavoriteReveal favorites={["Khabib Nurmagomedov", "islam makhachev", "Khamzat Chimaev"]}>UFC</FavoriteReveal> and WWE <span className="font-instrument italic text-gray-500 dark:text-zinc-500">(the drama is unmatched)</span>, <FavoriteReveal favorites={["Lose my mind", "Do you think you could love me (Yung Kai)", "Blinding Lights"]}>good music</FavoriteReveal>, binge-worthy <FavoriteReveal favorites={["Bhay: The Gaurav Tiwari Mystery", "Stranger Things", "Panchayat"]}>web series</FavoriteReveal>, and the occasional <FavoriteReveal favorites={["Free Fire", "Call of Duty"]}>Games</FavoriteReveal> session when I need to unplug.
                            </div>
